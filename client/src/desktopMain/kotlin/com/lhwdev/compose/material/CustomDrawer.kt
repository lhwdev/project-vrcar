...
fun ModalDrawerLayout(
	...
	scrimColor: Color = Color.Black.copy(alpha = DrawerDefaults.ScrimOpacity),
	...
	WithConstraints(modifier.fillMaxSize()) {
		...
		Box(
			...
			Surface(
				...
				}.offset { IntOffset(drawerState.offset.value.roundToInt(), 0) }.padding(end = VerticalDrawerPadding)
				...
				Column(Modifier.fillMaxHeight(), content = drawerContent)
			}
		}
	}
}
