...
private val sWindowDock by lazy {
	materialIcon("WindowDock") {
		path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
			...
			arcTo(2.0f, 2.0f, 0.0f, isMoreThanHalf = false, isPositiveArc = true, 2.0f, 18.0f)
			verticalLineTo(8.0f)
			horizontalLineTo(4.0f)
			verticalLineTo(18.0f)
			moveTo(22.0f, 6.0f)
			verticalLineTo(14.0f)
			arcTo(2.0f, 2.0f, 0.0f, isMoreThanHalf = false, isPositiveArc = true, 20.0f, 16.0f)
			horizontalLineTo(8.0f)
			arcTo(2.0f, 2.0f, 0.0f, isMoreThanHalf = false, isPositiveArc = true, 6.0f, 14.0f)
			verticalLineTo(6.0f)
			arcTo(2.0f, 2.0f, 0.0f, isMoreThanHalf = false, isPositiveArc = true, 8.0f, 4.0f)
			horizontalLineTo(20.0f)
			arcTo(2.0f, 2.0f, 0.0f, isMoreThanHalf = false, isPositiveArc = true, 22.0f, 6.0f)
			moveTo(20.0f, 6.0f)
			horizontalLineTo(8.0f)
			verticalLineTo(14.0f)
			horizontalLineTo(20.0f)
